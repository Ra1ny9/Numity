...
1. Even/Odd
2. Greater/Smaller than a random number
3. Divisibility (by 3 or 4)
4. Reversed number is even/odd
5. Perfect cube check
6. In first 10 digits of Pi
7. Fibonacci sequence check
8. Sum of prime factors
9. Perfect square root check
10. Digit sum
